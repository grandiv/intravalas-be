...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    embedType: Schema.Attribute.Enumeration<['iframe', 'script', 'oembed']>;
    embedUrl: Schema.Attribute.String;
    isEmbed: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::article.article'
...
export interface ApiCurrencyCurrency extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    changePercentage: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    code: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    createdAt: Schema.Attribute.DateTime;
    ...
    > &
      Schema.Attribute.Private;
    middleRate: Schema.Attribute.Decimal & Schema.Attribute.Required;
